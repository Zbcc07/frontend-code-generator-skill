...
```bash
npx skills add https://github.com/yourname/frontend-code-generator-skill --skill frontend-code-generator
```
...
copy frontend-code-generator-skill\skills\frontend-code-generator\SKILL.md %USERPROFILE%\.codebuddy\skills\frontend-code-generator\
copy frontend-code-generator-skill\skills\frontend-code-generator\references %USERPROFILE%\.codebuddy\skills\frontend-code-generator\

# 或 Mac/Linux
cp -r frontend-code-generator-skill/skills/frontend-code-generator/* ~/.codebuddy/skills/frontend-code-generator/
```
...
- `skills/frontend-code-generator/SKILL.md` - Skill 核心配置文件
- `skills/frontend-code-generator/references/coding-standards.md` - 详细开发规范
- `skills/frontend-code-generator/references/api-doc-template.md` - 接口文档模板

## 目录结构说明

本仓库采用 `npx skills add` 兼容的目录结构：

```
frontend-code-generator-skill/
├── skills/
│   └── frontend-code-generator/    # Skill 实际内容
│       ├── SKILL.md
│       └── references/
├── README.md
├── LICENSE
